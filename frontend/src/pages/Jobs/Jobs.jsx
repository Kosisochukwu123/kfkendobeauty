...
const UploadIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M3 15V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
)
...
export default function Jobs() {
  ...
  const selectVacancy = (v) => {
    ...
    setTimeout(() => {
      document.getElementById('jobs-form')?.scrollIntoView({ behavior: 'smooth', block: 'start' })
    }, 100)
  }
    ...
    <div className="page-enter">
      ...
      <div className="jobs-page__hero">
        ...
        <p className="jobs-page__hero-desc">
          We are always looking for talented, passionate beauty professionals
          to grow with us. Browse our current openings and apply below.
        </p>
        {/* Visible SEO text — helps Google surface this page for "Kfkendo vacancy" searches */}
        <div className="jobs-page__seo-tag">
          Now Hiring · Kfkendo Beauty Vacancies · Lagos Nigeria
        </div>
      </div>
            ...
            {vacancies.map((v) => (
              ...
              >
                <div className="vacancy-card__top">
                  ...
                  <span className={`vacancy-card__type ${typeClass[v.typeKey]}`}>
                    {v.type}
                  </span>
                </div>
                ...
                <div className="vacancy-card__tags">
                  {v.tags.map(t => (
                    <span className="vacancy-card__tag" key={t}>{t}</span>
                  ))}
                </div>
                ...
                <form className="jobs-form" onSubmit={handleSubmit} noValidate>
                  <div className="form-row">
                    <div className="form-group">
                      ...
                      <input id="firstName" name="firstName" type="text"
                        className="form-group__input" placeholder="Your first name"
                        value={form.firstName} onChange={handleChange} />
                      {errors.firstName && <p className="jobs-form__error">{errors.firstName}</p>}
                    </div>
                    <div className="form-group">
                      <label className="form-group__label" htmlFor="lastName">Last Name *</label>
                      <input id="lastName" name="lastName" type="text"
                        className="form-group__input" placeholder="Your last name"
                        value={form.lastName} onChange={handleChange} />
                      {errors.lastName && <p className="jobs-form__error">{errors.lastName}</p>}
                    </div>
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input id="email" name="email" type="email"
                      className="form-group__input" placeholder="your@email.com"
                      value={form.email} onChange={handleChange} />
                    {errors.email && <p className="jobs-form__error">{errors.email}</p>}
                  </div>

                  <div className="form-group">
                    <label className="form-group__label" htmlFor="phone">Phone Number *</label>
                    <input id="phone" name="phone" type="tel"
                      className="form-group__input" placeholder="+234 xxx xxx xxxx"
                      value={form.phone} onChange={handleChange} />
                    {errors.phone && <p className="jobs-form__error">{errors.phone}</p>}
                  </div>

                  <div className="form-group">
                    <label className="form-group__label" htmlFor="experience">Years of Experience</label>
                  ...
                  <div className="form-group">
                    ...
                    {errors.about && <p className="jobs-form__error">{errors.about}</p>}
                  </div>

                  {/* CV Upload */}
                  <div className="form-group">
                    <label className="form-group__label">CV / Portfolio (optional)</label>
